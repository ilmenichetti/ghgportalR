...
There might be errors in some series, and the API might not be able to retrieve some of them. To check which ones we can retrieve, we can use the following function:
